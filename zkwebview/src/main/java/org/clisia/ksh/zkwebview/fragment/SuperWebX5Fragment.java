package org.clisia.ksh.zkwebview.fragment;
...
import org.clisia.ksh.zkwebview.IWebLayout;
import org.clisia.ksh.zkwebview.R;
...
public class SuperWebX5Fragment extends Fragment implements FragmentKeyDown {
    ...
    public static final String KEY_UTL = "url_key";
    public static final String KEY_TOOLBAR_VISIBLE = "toolbar_visible_key";
...
//        mSuperWebX5.getWebCreator().get().setOverScrollMode(android.webkit.WebView.OVER_SCROLL_NEVER);
    ...
    public String getUrl() {
        String target = "";
        if (TextUtils.isEmpty(target = this.getArguments().getString(KEY_UTL))) {
     ...
     * @return
     */
    public boolean getToolbarInVisible(){
        return this.getArguments().getBoolean(KEY_TOOLBAR_VISIBLE);
    }
    ...
    protected void initView(View view) {
        ...
        toolbar.setVisibility(getToolbarInVisible()?View.VISIBLE:View.GONE);
